        ...
        if (this.getAttribute("useExpressInstall")) {
            ...
            if (this.installedVer.versionIsValid(_21)
                ...
                this.addVariable("MMredirectURL",
                                 encodeURIComponent(this.getAttribute("xiRedirectUrl")));
                document.title =
        ...
        if (this.skipDetect || this.getAttribute("doExpressInstall")
            ...
            if (!(navigator.plugins && navigator.mimeTypes.length))
                window[this.getAttribute('id')] =
                    document.getElementById(this.getAttribute('id'));
            return true;
        }
        else {
...
deconcept.SWFObjectUtil.getPlayerVersion = function()
{
    ...
    if (navigator.plugins && navigator.mimeTypes.length) {
        ...
        if (x && x.description) {
            _23 =
                new deconcept.PlayerVersion(x.description.
                                            replace(/([a - zA - Z] | \s) + /,
                                                    "").replace(/(\s + r | \s +
                                                                  b[0 - 9] +) /,
                                                                ".").split("."));
        ...
        if (navigator.userAgent && navigator.userAgent.indexOf("Windows CE") >= 0) {
            ...
            if (axo != null) {
                _23 =
                    new deconcept.PlayerVersion(axo.GetVariable("$version").split(" ")[1].
                                                split(","));
            }
        }
    }
